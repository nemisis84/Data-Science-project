...
def NaiveBayes(train_set, test_set, target, metric: str = "accuracy"):
    ...
    savefig(f"../../figures/modeling/NB/{target}_NB_{metric}_study.png")
    clf()
...
def best_model_results(train_set, test_set, target, approach, model_name, metric, params = ()):
    ...
    savefig(f'../../figures/modeling/NB/{target}_NB_{model_description["name"]}_best_{model_description["metric"]}_eval.png')
    clf()
